    ...
    <div className="w-11/12 mb-4 mx-auto border rounded-lg bg-stone-100">
      ...
      <div className="flex flex-wrap justify-start mx-auto rounded-lg mb-4">
        {categories.slice(0, 4).map((category) => (
          <div
            key={category.id}
            className="m-auto mt-4 w-full sm:w-1/2 md:w-1/3 lg:w-1/4 xl:w-1/5 transform overflow-hidden rounded-lg bg-white dark:bg-slate-800 shadow-md duration-300 hover:scale-105 hover:shadow-lg cursor-pointer"
